...
namespace LB.DemoService.WebApi.ClientSdk
{
    ...
    public partial class DateOnly
    {
        ...
        public DateOnly(int @day, int @dayNumber, DayOfWeek @dayOfWeek, int @dayOfYear, int @month, int @year)
    ...
    public partial class WeatherForecast
    {
        ...
        public WeatherForecast(DateOnly @date, string @summary, int @temperatureC, int @temperatureF)
